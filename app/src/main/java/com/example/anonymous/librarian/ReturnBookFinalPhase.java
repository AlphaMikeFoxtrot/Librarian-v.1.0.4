...
public class ReturnBookFinalPhase extends AppCompatActivity {
    ...
    public class GetIssuedBookDetailsAsyncTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            final String GET_ISSUED_BOOK_DETAILS_URL = "https://suppliant-fives.000webhostapp.com/librarian/get_single_issued_book_details.php";
    ...
    public class ReturnBookAsyncTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            final String RETURN_BOOK_URL = "https://suppliant-fives.000webhostapp.com/librarian/return_book.php";
