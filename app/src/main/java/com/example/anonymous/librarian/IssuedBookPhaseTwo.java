    ...
    public class GetSubscribersAsyncTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                URL url = new URL(new ServerScriptsURL(IssuedBookPhaseTwo.this).GET_SUBSCRIBERS_DETAILS());
    ...
    public class IssueBookCancelProtocol extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                URL url = new URL(new ServerScriptsURL(IssuedBookPhaseTwo.this).CANCEL_ISSUE_BOOK_PROTOCOL());
                httpURLConnection = (HttpURLConnection) url.openConnection();
